...
class ChatHistory:
    ...
    def initialize_assistant_history(self, uploaded_file):
        st.session_state["assistant"] = [self.default_prompt("output.csv")]
        ...
        if st.session_state["assistant"]:
            with container:
                for i in range(len(st.session_state["assistant"])):
                    ...
                    message(st.session_state["assistant"][i], key=str(i), avatar_style="icons", seed="Snuggles")  # noqa: E501
